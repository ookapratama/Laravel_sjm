...
<body class="index-page">
    <header class="header d-flex align-items-center fixed-top" id="header">
        <div
            ...
            @guest
                ...
                <a class="btn-getstarted" href="{{ route('referral.register') }}">Register</a>
            @else
                @php
                    $role = Auth::user()->role;
    ...
    <main class="main">
                        ...
                        <div class="content">
                            ...
                            <div class="description">
                                <p>Dapatkan penghasilan tak terbatas melalui sistem MLM Binary yang adil dan transparan.
                                    Bonus pairing hingga Rp16.000.000 per level, dukungan penuh dari tim, dan produk
                                    berkualitas tinggi. Gabung sekarang — karena sukses tidak perlu ditunda!</p>
                            </div>
                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
                        <div class="about-image position-relative">
                            <img alt="About Image" class="img-fluid rounded-4 shadow-sm" loading="lazy"
                                src="front/assets/img/about/kantor.webp" />
                    ...
                    <div class="col-lg-6 mt-4 mt-lg-0" data-aos="fade-left" data-aos-delay="300">
                        <div class="about-content">
                            ...
                            <p class="lead">Menjadi perusahaan distribusi dan pengembangan jaringan terbaik di
                                Indonesia yang mendorong pertumbuhan ekonomi mandiri, serta membawa perubahan positif
                                bagi masyarakat melalui peluang usaha yang jujur, berkelanjutan, dan saling
                                menguntungkan.</p>
                            <h2>Misi Perusahaan</h2>
                            <p class="lead">Membangun jaringan bisnis yang kuat, profesional, dan berintegritas
                                melalui sistem kemitraan dan edukasi yang transparan. Memberikan peluang usaha kepada
                                masyarakat luas dengan modal terjangkau dan sistem bonus yang adil. Meningkatkan
                                kesejahteraan para mitra melalui produk berkualitas dan dukungan pelatihan yang
                                berkelanjutan. Menjadi wadah pertumbuhan bersama (Tumbuh Bersama) di mana setiap
                                individu memiliki kesempatan yang sama untuk sukses. Mengembangkan inovasi digital dan
                                teknologi sistem binary untuk mempercepat dan mempermudah pencapaian mitra di seluruh
                                Indonesia.</p>
                    ...
                    <div class="step-item" data-aos="fade-right" data-aos-delay="200">
                        <div class="step-content">
                            ...
                            <div class="step-info">
                                ...
                                <p>
                                    <li>Isi data diri lengkap di halaman pendaftaran.</li>
                                    <li>Pilih paket keanggotaan sesuai kebutuhan Anda.</li>
                                    <li>Aktivasi akun dan langsung dapatkan <strong class="text-green-600">voucher
                                            bonus awal senilai Rp7.500.000</strong>!</li>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="step-item" data-aos="fade-left" data-aos-delay="300">
                        <div class="step-content">
                            ...
                            <div class="step-info">
                                ...
                                <p>
                                    <li>Ajak 2 orang pertama Anda bergabung.</li>
                                    <li>Tempatkan satu di kiri dan satu di kanan.</li>
                                    <li>Langsung dapat <strong class="text-blue-600">Bonus Pairing Level 1 sebesar
                                            Rp1.000.000</strong>!</li>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="step-item" data-aos="fade-right" data-aos-delay="400">
                        <div class="step-content">
                            ...
                            <div class="step-info">
                                ...
                                <p>
                                    <li>Terus kembangkan jaringan Anda.</li>
                                    <li>Dapatkan bonus pairing hingga level 10 dan ulangi cycle.</li>
                                    <li>Reaktivasi untuk terus hasilkan cuan tanpa batas!</li>
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <article class="portfolio-entry">
                                <figure class="entry-image">
                                    <img alt="" class="img-fluid" loading="lazy"
                                        src="front/assets/img/portfolio/produk.webp" />
                                    <div class="entry-overlay">
                                        <div class="overlay-content">
                                            <div class="entry-meta">Azka</div>
                                            <h3 class="entry-title">Of Arabia</h3>
                                            <div class="entry-links">
                                                <a class="glightbox" data-gallery="portfolio-gallery-ui"
                                                    data-glightbox="title: Azka Of Arabiah description: Praesent commodo cursus magna, vel scelerisque nisl consectetur."
                                                    href="front/assets/img/portfolio/produk.wep">
                        ...
                        <div class="row g-4 isotope-container" data-aos="fade-up" data-aos-delay="300">
                            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-ui">
                                <article class="portfolio-entry">
                                    <figure class="entry-image">
                                        <img alt="" class="img-fluid" loading="lazy"
                                            src="front/assets/img/portfolio/produk2.webp" />
                                        <div class="entry-overlay">
                                            <div class="overlay-content">
                                                ...
                                                <div class="entry-links">
                                                    <a class="glightbox" data-gallery="portfolio-gallery-ui"
                                                        data-glightbox="title: Jaspear Bloom  description: Praesent commodo cursus magna, vel scelerisque nisl consectetur."
                                                        href="front/assets/img/portfolio/produk2.webp">
                                                        <i class="bi bi-arrows-angle-expand"></i>
                                                    </a>
                                                    <a href="portfolio-details.html">
                                                        <i class="bi bi-arrow-right"></i>
                ...
                <div class="row gy-4">
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="team-member d-flex">
                            <div class="member-img">
                                <img alt="" class="img-fluid" loading="lazy"
                                    src="front/assets/img/person/5.webp" />
                            </div>
                            <div class="member-info flex-grow-1">
                                <h4>Hj.Satriani</h4>
                                <span>Komisaris</span>
                                <p>“Saya di balik layar, memastikan semuanya berjalan lancar. Kalian yang di garis depan
                                    — saya hanya bantu menyalakan panggungnya.”</p>
                                <div class="social">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="team-member d-flex">
                            <div class="member-img">
                                <img alt="" class="img-fluid" loading="lazy"
                                    src="front/assets/img/person/3.webp" />
                            </div>
                            <div class="member-info flex-grow-1">
                                <h4>H. Irwan S.E</h4>
                                <span>CEO</span>
                                <p>“Bergabung dengan SJM bukan hanya soal cuan, tapi juga membangun masa depan. Saya
                                    pastikan sistem ini terus berkembang bersama Anda.”</p>
                                <div class="social">
                                    <a href=""><i class="bi bi-facebook"></i></a>
                                    <a href=""><i class="bi bi-twitter-x"></i></a>
                                    <a href=""><i class="bi bi-linkedin"></i></a>
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="team-member d-flex">
                            <div class="member-img">
                                <img alt="" class="img-fluid" loading="lazy"
                                    src="front/assets/img/person/2.webp" />
                            </div>
                            <div class="member-info flex-grow-1">
                                <h4>H. Kamri S.Pd</h4>
                                <span>Enginer</span>
                                <p>“Tugas saya adalah memastikan setiap proses dalam sistem Sair Beauty berjalan
                                    efisien, aman, dan sesuai kebutuhan bisnis. </p>
                                <div class="social">
                                    <a href=""><i class="bi bi-facebook"></i></a>
                                    <a href=""><i class="bi bi-twitter-x"></i></a>
                                    <a href=""><i class="bi bi-linkedin"></i></a>
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="team-member d-flex">
                            <div class="member-img">
                                <img alt="" class="img-fluid" loading="lazy"
                                    src="front/assets/img/person/4.webp" />
                            </div>
                            <div class="member-info flex-grow-1">
                                <h4>Halim AK</h4>
                                <span>System Analist</span>
                                <p>“Dengan pengalaman membangun sistem MLM yang dinamis, saya percaya teknologi adalah
                                    kunci pertumbuhan SJM. Bersama, kita tumbuh, kita jaya!”</p>
                                <div class="social">
                                    <a href=""><i class="bi bi-facebook"></i></a>
                                    <a href=""><i class="bi bi-twitter-x"></i></a>
                                    <a href=""><i class="bi bi-linkedin"></i></a>
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="team-member d-flex">
                            <div class="member-img">
                                <img alt="" class="img-fluid" loading="lazy"
                                    src="front/assets/img/person/1.webp" />
                            </div>
                            <div class="member-info flex-grow-1">
                                <h4>Muhammad Ikhsan S.Kom</h4>
                                <span>Software Enginer</span>
                                <p>Kami membangun sistem ini dengan fokus pada keamanan, kecepatan, dan kemudahan.
                                    Tujuan kami adalah menciptakan platform yang bisa mendorong kesuksesan semua member
                                    Sair Beauty.</p>
                                <div class="social">
                                    <a href=""><i class="bi bi-facebook"></i></a>
                                    <a href=""><i class="bi bi-twitter-x"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                        <div class="pricing-card">
                            ...
                            <div class="plan-features">
                                <ul>
                                    <li class="disabled"><i class="bi bi-check-circle-fill"></i> Langsung Dapat Bonus
                                        Pasangan</li>
                                    <li class="disabled"><i class="bi bi-check-circle-fill"></i> Bonus Lebih Banyaks
                                    </li>
                                    <li><i class="bi bi-check-circle-fill"></i> 2 Direct Sponsor Dapatkan Bonusnyat
                                    </li>
                                </ul>
                            </div>
                            <div class="plan-cta">
        ...
        <section class="contact section" id="contact">
            ...
            <div class="map-section" data-aos="fade-up" data-aos-delay="200">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3973.453564551408!2d119.46832407523111!3d-5.191159694786379!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dbee300460f70f1%3A0x661b686d91c7735e!2sPT%20SAIR%20JAYA%20MANDIRI!5e0!3m2!1sid!2sid!4v1754561211883!5m2!1sid!2sid"
                ...
                <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="300">
                    <div class="col-lg-10">
                        <div class="contact-form-wrapper">
                            ...
                            @endif
                            <form id="pre-register-form" action="{{ route('pre-register.store') }}" method="POST"
                                ...
                                <div class="row g-3">
                                        ...
                                        <div class="form-group">
                                            <div class="input-with-icon">
                                                ...
                                                <input class="form-control" name="name"
                                                    placeholder="Nama Sesuai KTP" type="text" required>
                                            </div>
                                        </div>
                                    </div>
                                    {{-- Email --}}
                                        ...
                                        <div class="form-group">
                                            <div class="input-with-icon">
                                                ...
                                                <input class="form-control" name="phone"
                                                    placeholder="No WhatsApp Aktif" type="text" required>
                                            </div>
                                        </div>
                                    </div>
                                    {{-- Sponsor --}}
                                        ...
                                        <div class="form-group">
                                            <div class="input-with-icon">
                                                ...
                                                <input class="form-control" name="sponsor_id"
                                                    placeholder="Kode Sponsor" type="text" required>
                                            </div>
                                        </div>
                                    </div>
                                    {{-- Metode Pembayaran --}}
                                            ...
                                            <div class="d-flex flex-column flex-md-row gap-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio"
                                                        name="payment_method" id="method_rekening" value="rekening"
                                                        required>
                                                    <label class="form-check-label text-white"
                                                        for="method_rekening">Transfer ke Rekening</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12" id="rekening-info" style="display: none;">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="payment_proof" class="form-label text-white">Upload Bukti
                                                    Pembayaran</label>
                                                <div class="drop-zone" id="drop-zone-area"
                                                    onclick="document.getElementById('payment_proof').click()">
                                                    <span class="drop-zone-text" id="drop-zone-label">Klik atau drag
                                                        file ke sini</span>
                                                    <input type="file" name="payment_proof" id="payment_proof"
                                                        class="drop-zone-input" required
                                    ...
                                    <div class="col-12 text-center">
                                        <button class="btn btn-warning btn-submit" id="submit-btn"
                                            type="submit">Kirim Pendaftaran</button>
                                    </div>
                                    <div class="col-12">
                    ...
                    <div class="modal-content bg-dark text-white border border-warning">
                        ...
                        <div class="modal-body text-center">
                            ...
                            <img id="qr-image" src="" alt="QRIS"
                                class="img-fluid border border-warning rounded" style="max-width: 250px;">
                            <p class="mt-3" id="countdown">Waktu tersisa: <strong>10:00</strong></p>
                            <p id="waiting-text" class="text-warning">Menunggu pembayaran...</p>
                        </div>
                        <a href="#" id="simulate-link" target="_blank"
                            class="btn btn-sm btn-outline-light mt-3 d-none">
    ...
    <footer class="footer" id="footer">
        ...
        <div class="container copyright text-center mt-4">
            <p>© <span>Copyright 2025</span> <strong class="px-1 sitename">Sair Jaya Mandiri</strong> <span>All Rights
                    Reserved</span></p>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                if (paymentMethod && paymentMethod.value === 'rekening' && paymentProofInput.files
                    .length === 0) {
                    ...
                    .catch(error => {
                        ...
                        if (error.errors) {
                            ...
                            toastr.error("❌ " + (error.message ||
                                "Terjadi kesalahan. Silakan periksa kembali formulir Anda."));
            ...
            function showQrisModal(qrUrl) {
                ...
                const interval = setInterval(() => {
                    if (time <= 0) {
                        ...
                        countdown.innerHTML =
                        "<span class='text-danger fw-bold'>QR telah kadaluarsa</span>";
                    } else {
