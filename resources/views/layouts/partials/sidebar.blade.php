    ...
    <div class="sidebar-content">
        <ul class="nav nav-secondary">
            ...
            @switch($role)
                ...
                @case('super-admin')
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="jaringan">
                            <ul class="nav nav-collapse">
                                <ul class="nav nav-collapse">
                                <li><a href="/tree" class="menu-bagan" data-bagan="1"><span
                                            class="sub-item">Basic</span></a></li>
                                <li><a href="#" class="menu-bagan" data-bagan="2"><span class="sub-item">Bintang 1
                                            P1</span></a></li>
                                <li><a href="#" class="menu-bagan"data-bagan="3"><span class="sub-item">Bintang 2
                                            P2</span></a></li>
                                <li><a href="#" class="menu-bagan" data-bagan="4"> <span class="sub-item">Bintang 3
                                            P3</span></a></li>
                                <li><a href="#" class="menu-bagan" data-bagan="5"> <span class="sub-item">Bintang 4
                                            P4</span></a></li>
                                <li><a href="#" class="menu-bagan" data-bagan="6"> <span class="sub-item">Bintang 5
                                            P5</span></a></li>
                                <li><a href="#" class="menu-bagan" data-bagan="7"> <span class="sub-item">Bintang 6
                                            P6</span></a></li>
                            </ul>
                    ...
                    {{-- Pre-register --}}
                    <li class="nav-item"><a href="/member/pins"><i class="fas fa-cart-plus"></i>
                            <p>Pin Aktivasi</p>
                        </a></li>
                ...
                {{-- ADMIN --}}
                @case('admin')
                    <li class="nav-item"><a href="/tree"><i class="fas fa-sitemap"></i>
                            <p>Jaringan Saya</p>
                        </a></li>
                    <li class="nav-item"><a href="/bonus"><i class="fas fa-money-check-alt"></i>
                            <p>Bonus Saya</p>
                        </a></li>
                    <li class="nav-item"><a href="/admin/withdraw"><i class="fas fa-credit-card"></i>
                            <p>Penarikan Bonus</p>
                        </a></li>
                    {{-- <li class="nav-item"><a href="/orders"><i class="fas fa-cart-plus"></i><p>Repeat Order</p></a></li> --}}
                    <li class="nav-item"><a href="/notifications"><i class="fas fa-bell"></i>
                            <p>Notifikasi</p>
                        </a></li>
                    <li class="nav-item"><a href="/help"><i class="fas fa-headset"></i>
                            <p>Bantuan</p>
                        </a></li>
                    <li class="nav-item"><a href="/admin/withdraws"><i class="fas fa-wallet"></i>
                            <p>Permintaan Withdraw</p>
                        </a></li>
                    <li class="nav-item"><a href="/data-member"><i class="fas fa-users"></i>
                            <p>Data Member</p>
                        </a></li>
                    <li class="nav-item"><a href="/admin/pre-register"><i class="fas fa-user-check"></i>
                            <p>Pre-Registrasi</p>
                        </a></li>
                    <li class="nav-item"><a href="/admin/pin-requests"><i class="fas fa-user-check"></i>
                            <p>Pin Aktivasi</p>
                        </a></li>
                    {{-- <li class="nav-item"><a href="{{ route('admin.products.index') }}"><i class="fas fa-box"></i>
                            <p>Produk</p>
                        </a></li> --}}
                    <li class="nav-item">
                        <a data-bs-toggle="collapse" href="#produk">
                            <i class="fas  fa-box"></i>
                            <p>Kelola Produk dan Paket</p>
                            <span class="caret"></span>
                        </a>
                ...
                @case('finance')
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="manajemen">
                            <ul class="nav nav-collapse">
                                <li><a href="/finance/pre-registrations"><span class="sub-item">Member
                                            Pre-Registrasi</span></a></li>
                ...
                @case('member')
                    ...
                    <li class="nav-item"><a href="/member/downline"><i class="fas  fa-users-cog"></i>
                            <p>Data Downline</p>
                        </a></li>
                    <li class="nav-item"><a href="/bonus"><i class="fas fa-money-check-alt"></i>
                            <p>Bonus Saya</p>
                        </a></li>
                    <li class="nav-item"><a href="/member/withdraw"><i class="fas fa-credit-card"></i>
                            <p>Penarikan Bonus</p>
                        </a></li>
                    <li class="nav-item"><a href="/member/pins"><i class="fas fa-cart-plus"></i>
                            <p>Pin Aktivasi</p>
