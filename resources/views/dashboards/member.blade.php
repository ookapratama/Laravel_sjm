        ...
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <div class="d-flex flex-wrap justify-content-center gap-2 mb-2">
                    <span id="referralLink" class="badge bg-dark px-3 py-2" style="cursor:pointer;"
                ...
                <ul class="list-group list-group-flush">
                    @foreach ($baganNames as $bagan => $label)
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            @else
                                <button type="button" class="btn btn-warning btn-sm mt-2" data-bagan="{{ $bagan }}"
                                    data-nama="{{ $label }}" data-biaya="{{ $biaya[$bagan] }}"
                                    data-allocated="{{ $allocated }}" onclick="openUpgradeModal(this)">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div id="bonusInfo" class="mt-3">
                                ...
                                <p>Saldo bonus tersedia:
                                    <strong>Rp{{ number_format($saldoBonusTersedia, 0, ',', '.') }}</strong></p>
                            </div>
                            ...
                            <div id="manualTransferSection" style="display: none;">
                                <hr>
                                <p class="text-danger">Saldo tidak mencukupi. Silakan transfer manual ke rekening berikut:
                                </p>
