...
@section('content')
    <div class="page-inner">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="card card-stats card-round" role="button" data-bs-toggle="modal"
                    data-bs-target="#withdrawModal">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-icon">
                                <div class="icon-big text-center icon-secondary bubble-shadow-small">
                                    <i class="fas fa-paper-plane" data-bs-toggle="tooltip" title="Ajukan pencairan bonus"
                                        data-bs-placement="top" data-bs-target="#withdrawModal" style="cursor: pointer;"
    ...
    <script>
        ...
        `;
                            document.getElementById('withdraw-history-body').insertAdjacentHTML(
                                'afterbegin', row);
                            form.reset();
            ...
            function fetchBonusAvailable() {
                fetch('{{ route('member.withdraw.bonus') }}')
                    ...
                    .then(data => {
                        ...
                        availableBonus = parseFloat(data.bonus_raw ??
                            0); // backend wajib kirim bonus_raw (angka)
